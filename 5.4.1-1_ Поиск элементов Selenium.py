...
# в новых версиях селениума (4.3.0) browser.find_element_by_id("sale_button").click() надо заменить на
# browser.find_element("id", "sale_button").click()
import time
from selenium import webdriver

browser = webdriver.Chrome()
browser.get('http://parsinger.ru/html/watch/1/1_1.html')
button = browser.find_element("id", "sale_button").click()
time.sleep(10)
